...
! Simply return if any pointer not found
  ...
  if(dbz_exist)then
    ...
    call gsi_bundlegetpointer(rval,'qr',rdbz,istatus);ier=istatus+ier
...
!       Adjoint
        if(dbz_exist)then
          valdbz = grad
          rdbz(j1)=rdbz(j1)+100.*dbzptr%jqr
          rdbz(j2)=rdbz(j2)+100.*dbzptr%jqr
          rdbz(j3)=rdbz(j3)+100.*dbzptr%jqr
          rdbz(j4)=rdbz(j4)+100.*dbzptr%jqr
          rdbz(j5)=rdbz(j5)+100.*dbzptr%jqr
          rdbz(j6)=rdbz(j6)+100.*dbzptr%jqr
          rdbz(j7)=rdbz(j7)+100.*dbzptr%jqr
          rdbz(j8)=rdbz(j8)+100.*dbzptr%jqr

          rqg(j1)=rqg(j1)+100.*dbzptr%jqg
          rqg(j2)=rqg(j2)+100.*dbzptr%jqg
          rqg(j3)=rqg(j3)+100.*dbzptr%jqg
          rqg(j4)=rqg(j4)+100.*dbzptr%jqg
          rqg(j5)=rqg(j5)+100.*dbzptr%jqg
          rqg(j6)=rqg(j6)+100.*dbzptr%jqg
          rqg(j7)=rqg(j7)+100.*dbzptr%jqg
          rqg(j8)=rqg(j8)+100.*dbzptr%jqg
        else
